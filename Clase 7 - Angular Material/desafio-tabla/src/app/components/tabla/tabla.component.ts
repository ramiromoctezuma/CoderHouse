...
import { EditarDialogComponent } from '../../componnets/editar-dialog/editar-dialog.component';
...
export class TablaComponent implements OnInit {
  ...
  columnas: string[] = ['nombre', 'comision', 'profesor', 'numeroEstudientes', 'matriculaBbierta', 'acciones'];
